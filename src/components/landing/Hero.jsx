...
export default function HeroSection() {
  return (
    <div className="relative overflow-clip text-white bg-gradient-to-b from-neutral-950  to-[#525CEB] mb-20 md:mb-44">
      ...
      <div className="absolute bg-blue-100 w-[1400px] xl:w-[120svw] h-[40rem] rounded-[50%] left-1/2 -translate-x-1/2 top-[350px] md:top-[400px] blur-xl"></div>
      <div
        className="absolute bg-neutral-950 w-[1400px] xl:w-[120svw] h-[40rem] rounded-[50%] left-1/2 -translate-x-1/2 top-[350px] md:top-[400px] border-1 border-/30"
        style={{
      ...
      <div className="container relative mx-auto px-4 pt-12 pb-24 w-[90%]">
        <div className="flex flex-col items-center justify-center text-center z-10">
          ...
          <motion.div
            ...
            className="max-w-2xl"
          >
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tighter mb-4">
              Hi, I am <br /> Muhammad{" "}
              <span className="text-blue-400">Yusuf</span> Rahman
            </h1>
            <p className="text-sm md:text-base lg:text-lg text-white/80 max-w-2xl mx-auto leading-relaxed mb-6">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <a href="mailto:yusufrhmann@gmail.com">
                <Button className={"text-sm md:text-base"} reverse>
                  Contact Me
                </Button>
              </a>
            </div>
